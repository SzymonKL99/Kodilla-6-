...
class ForumUserTestSuite {
    ...
    void testGetLocationsOfFriendsOfFriends() {
        ...
        assertEquals(3, user1.getLocationOfFriendsFriends().size());
        assertTrue(user1.getLocationOfFriendsFriends().contains("Key West"));
        assertTrue(user1.getLocationOfFriendsFriends().contains("Washington"));
        assertTrue(user1.getLocationOfFriendsFriends().contains("Miami"));
        assertFalse(user1.getLocationOfFriendsFriends().contains("Orlando"));
    }
}